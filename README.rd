...
\enumerate{
 ...
 \item If you’re working on a Programming Assignment or Peer Review, you can \cr 
 download your Lab files to your local computer and upload them directly to the \cr
 assignment. If you are working on a Quiz, you can use your Lab environment to \cr
 complete your work and then select your responses directly within the quiz.\cr
 \item If you have any questions as you get started, we recommend reviewing \cr
  \href{preview?file=~\%2FGetting+Started+with+Your+Lab.rd}{Getting Started with Your Lab} \cr
